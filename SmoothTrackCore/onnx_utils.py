import onnxruntime
from yolov7s.common import letterbox, onnx_inference, preprocess
...
class YOLODetect:
    ...
    def init_onnx_model(self, opt):
        ...
        self.session = onnxruntime.InferenceSession(
            opt.yolo_onnx_path, providers=providers
        )
    ...
    def inference_(self, frame):
        ...
        resized_image, ratio, dwdh = letterbox(
            frame, new_shape=self.new_shape, auto=False
        )
